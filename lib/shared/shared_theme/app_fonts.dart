...
class AppFonts {
  ...
  static TextStyle primaryBlackFont = TextStyle(color: AppColors.blackColor, fontSize: 20.0, fontWeight: FontWeight.bold);
  ...
  static TextStyle subBlackFont = TextStyle(color: AppColors.blackColor, fontSize: 15.0);
  static TextStyle subGreyFont = TextStyle(color: AppColors.greyColor, fontSize: 10.0);
  static TextStyle priamryGreyFont = TextStyle(color: AppColors.greyColor, fontSize: 15.0, fontWeight: FontWeight.bold);
}